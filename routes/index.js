...
router.get('/', function(req, res, next) {
    ...
    let infoText = {txt:'<i>Внимание!<br> Биржа работает в ручном режиме. Об ошибках и предложениях сообщать на support@prizmex.ru<br> Заявки обрабатываются с 7.00 до 21.00 МСК.</i><p>Для полноценного участия в обмене необходимо зарегистрироваться</p><p><br></p>', sign:'Администрация'};
    if(req.session.user){
        ...
        User.findById(req.session.user, function (err, user) {
            infoText.txt = 'Внимание!' +
                '<p>Биржа работает в ручном режиме. Об ошибках и предложениях сообщать на support@prizmex.ru<br>Заявки обрабатываются с 7.00 до 21.00 МСК.</p>';
