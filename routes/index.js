...
router.get('/', function(req, res, next) {
    ...
    let infoText = {txt:'<i>Внимание!<ul><li>Биржа работает в ручном режиме.</li><li>Заявки обрабатываются с 7.00 до 21.00 МСК.</li><li>Об ошибках и предложениях сообщать на support@prizmex.ru</li></ul></i><p>Для полноценного участия в обмене необходимо зарегистрироваться</p><p><br></p>', sign:'Администрация'};
    if(req.session.user){
